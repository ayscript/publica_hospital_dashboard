...
const PatientEnrollmentForm: React.FC = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-gray-100 rounded-lg shadow-sm border border-gray-100 mt-10">
            <h2 className="text-xl font-semibold text-gray-800 mb-6">Enroll New Patient</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    {/* Next Delivery Date */}
                    <div>
                        <label htmlFor="nextDeliveryDate" className="block text-sm font-medium text-gray-700 mb-1">
                            Next Delivery Date
                        </label>
                        <input
                            type="date"
